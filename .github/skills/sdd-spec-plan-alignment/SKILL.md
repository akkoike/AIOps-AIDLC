...
## 使用するタイミング
- `01_specify/requirements.md` と `02_plan/` 文書が存在するとき。
...
- `01_specify/requirements.md`
- 主要Plan文書（例: `02_plan/architecture.md`, `02_plan/assessment-design.md`, `02_plan/adr-summary.md`）
...
## 手順
1. `01_specify/requirements.md` から主要要件を抽出する。
2. `02_plan/*` から設計判断を抽出する。
